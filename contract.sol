/**
 * 
 Welcome to SpaceBunny!

Telegram: t.me/SpaceBunnyBSC
Website: SpaceBunny.app

A Fun & Unique NFT Play To Earn Game Live On The Binance Smart Chain.

Play and Collect extraordinary SpaceBunny NFTs.
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xa87D055CF6C5f01A3922FC7154A335215b1EcAae;
...
contract SpaceBunny is Context, IERC20, Ownable {
    ...
    address public _StackingWalletAddress = 0x61105B77d4F2cE0Bb34538Caf7c0edC68e56E73F;
    ...
    uint256 public _StackingFee = 20;
    uint256 private _previousDevelopmentFee = _StackingFee;
    ...
    function setStackingFeePercent(uint256 developmentFee) external onlyOwner() {
        _StackingFee = developmentFee;
    }
    ...
    function _takeDevelopment(uint256 tDevelopment) private {
        uint256 currentRate =  _getRate();
        uint256 rDevelopment = tDevelopment.mul(currentRate);
        _rOwned[_StackingWalletAddress] = _rOwned[_StackingWalletAddress].add(rDevelopment);
        if(_isExcluded[_StackingWalletAddress])
            _tOwned[_StackingWalletAddress] = _tOwned[_StackingWalletAddress].add(tDevelopment);
    }
    ...
    function calculateDevelopmentFee(uint256 _amount) private view returns (uint256) {
        return _amount.mul(_StackingFee).div(
            10**3
        );
    }
    ...
    function removeAllFee() private {
        ...
        _previousDevelopmentFee = _StackingFee;
    ...
    function restoreAllFee() private {
        ...
        _StackingFee = _previousDevelopmentFee;
